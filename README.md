...
[AgentRouter](https://agentrouter.org/register?aff=GD9A) [Sign up From My Link to get 250$ Credit] is a **free public AI gateway** that provides access to DeepSeek models (v3.2, v3.1, R1, etc.) and other LLMs at no cost. It was originally built for tools like KiloCode, RooCode, and OpenAI Codex.
