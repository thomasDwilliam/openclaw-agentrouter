...
[AgentRouter](https://agentrouter.org) is a **free public AI gateway** that provides access to DeepSeek models (v3.2, v3.1, R1, etc.) and other LLMs at no cost. It was originally built for tools like KiloCode, RooCode, and OpenAI Codex.
...
```bash
git clone https://github.com/yourname/openclaw-agentrouter.git
